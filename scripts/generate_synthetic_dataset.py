...
GENRE_PROFILES = {
    ...
    "indie": {
        ...
        "valence": (0.50, 0.22),
        "tempo": (115, 20),
        "acousticness": (0.35, 0.25),
        "instrumentalness": 0.10,
    },
    "rnb": {
        "danceability": (0.62, 0.12),
        "energy": (0.55, 0.15),
        "valence": (0.45, 0.20),
        "tempo": (98, 16),
        "acousticness": (0.25, 0.20),
        "instrumentalness": 0.03,
    },
    "country": {
        "danceability": (0.55, 0.13),
        "energy": (0.60, 0.15),
        "valence": (0.55, 0.20),
        "tempo": (115, 18),
        "acousticness": (0.40, 0.25),
    ...
    "classical": {
        ...
        "valence": (0.35, 0.22),
        "tempo": (95, 25),
        "acousticness": (0.85, 0.15),
        "instrumentalness": 0.78,
    },
    "jazz": {
        "danceability": (0.50, 0.15),
        "energy": (0.45, 0.20),
        "valence": (0.45, 0.22),
        "tempo": (112, 22),
        "acousticness": (0.55, 0.25),
        "instrumentalness": 0.30,
    },
    "metal": {
        "danceability": (0.42, 0.12),
        "energy": (0.92, 0.06),
        "valence": (0.30, 0.18),
        "tempo": (140, 25),
        "acousticness": (0.04, 0.06),
        "instrumentalness": 0.08,
    },
    "lofi": {
        "danceability": (0.55, 0.10),
        "energy": (0.30, 0.10),
        "valence": (0.45, 0.18),
        "tempo": (80, 10),
        "acousticness": (0.65, 0.15),
...
def generate_audio_features(n: int, seed: int = RNG_SEED) -> pd.DataFrame:
    ...
    for i in range(n):
        ...
        instrumentalness = float(
            np.clip(rng.beta(instr_p * 5 + 0.5, 5 - instr_p * 5 + 0.5), 0.0, 1.0)
        )
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--tracks", type=int, default=10500, help="Number of synthetic Spotify-shape track rows"
    )
    parser.add_argument(
        "--segments",
        type=int,
    ...
    print(
        f"  → {video_path} ({len(video_df)} rows across "
