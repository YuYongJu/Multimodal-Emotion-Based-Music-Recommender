...
def video_segments_dataframe() -> pd.DataFrame:
    ...
    rows = [
        {"Video": "v1.mp4", "Label Description": "fight",
         "Category Description": "Action", "Start Time": 0.0, "End Time": 3.0,
         "Confidence": 0.92},
        {"Video": "v1.mp4", "Label Description": "explosion",
         "Category Description": "Action", "Start Time": 3.0, "End Time": 5.5,
         "Confidence": 0.87},
        {"Video": "v1.mp4", "Label Description": "chase",
         "Category Description": "Action", "Start Time": 5.5, "End Time": 9.0,
         "Confidence": 0.81},
        {"Video": "v2.mp4", "Label Description": "sunset",
         "Category Description": "Nature", "Start Time": 0.0, "End Time": 4.0,
         "Confidence": 0.95},
        {"Video": "v2.mp4", "Label Description": "water",
         "Category Description": "Nature", "Start Time": 4.0, "End Time": 7.5,
         "Confidence": 0.91},
    ]
    return pd.DataFrame(rows)
